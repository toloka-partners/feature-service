...
class EmailNotificationIntegrationTest extends AbstractIT {
    ...
    void setUp() {
        ...
        // Note: Don't set default behavior for send() - let each test configure it as needed
    }
    ...
    void shouldSendMultipleEmailsForBatchNotifications() throws Exception {
        ...
        assertThat(totalNotifications)
                .as("Should create exactly 2 notifications for feature assignees (user1 and user2)")
                .isEqualTo(2);
