...
class ApplicationLifecycleListenerUnitTest {
    ...
    class KafkaExceptionTests {
        // Note: Kafka exception tests with static KafkaAdminClient.create() mocking
        // are covered by integration tests (ApplicationLifecycleListenerIT).
        // Unit tests cannot easily mock static method calls without additional
        // framework setup. These scenarios are thoroughly tested in integration tests.
    }
