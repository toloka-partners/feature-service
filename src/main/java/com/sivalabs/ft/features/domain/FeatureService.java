...
public class FeatureService {
    ...
    public List<FeatureDto> findFeaturesByReleaseAndParents(
        ...
        // If fromParentReleaseCode is empty, use the optimized query to fetch all features from release and its parents
        ...
        // Otherwise, use the original logic to traverse up to a specific parent
        ...
        // Find the specified parent release
